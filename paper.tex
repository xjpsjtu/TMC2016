...
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem J. Xie, F. Wu, and G. Chen are with the Department of Computer Science and Engineering, Shanghai Key Laboratory of Scalable Computing and Systems, Shanghai Jiao Tong University, Shanghai 200240, P.R. China.
Emails: xjpsjtu@sjtu.edu.cn, \{fwu, gchen\}@cs.sjtu.edu.cn.
...
\item We think about two cases according to the value function. The value function in these two cases is linear additive and submodular, the latter is more general.
\end{itemize}
